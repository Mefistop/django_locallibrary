...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author in range(num_of_authors):
            Author.objects.create(first_name='Christian %s' % author, last_name = 'Surname %s' % author,)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertFormError(
            resp.context['form'], 'renewal_date', 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(
            resp.context['form'], 'renewal_date', 'Invalid date - renewal more than 4 weeks ahead')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = datetime.date(2024, 10, 12)
